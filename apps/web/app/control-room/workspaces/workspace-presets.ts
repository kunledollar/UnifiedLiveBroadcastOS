...
export const workspaceProfiles: Record<WorkspaceProfile['id'], WorkspaceProfile> = {
  ...
  producer: {
    id: 'producer',
    label: 'Producer',
    description: 'Guests, outputs, rundown, and production management',
  ...
  'remote-production': {
    ...
    centerLayout: 'collaboration-focus',
    defaultViewMode: 'confidence',
    defaultOperationsTab: 'team',
    defaultDockTab: 'collaboration',
  ...
  'automation-operator': {
    ...
    description: 'Run of show, cues, macros, and countdown',
    centerLayout: 'automation-focus',
    defaultViewMode: 'program',
    defaultOperationsTab: 'automation',
    defaultDockTab: 'automation',
    defaultNavItem: 'scenes',
