...
export const workspaceCatalog:readonly WorkspaceDefinition[] = [
 ['director','Director','◆','Call the show with rundown and next-action support',geometry('director','program-dominant','horizontal-split',60,40,'protect-program')],
 ['solo-streamer','Solo Streamer','●','Keep the live confidence surface foremost',geometry('solo-streamer','program-dominant','horizontal-split',70,30,'protect-program',68)],
 ...
 ['graphics-operator','Graphics Operator','✦','Prepare graphics against the next scene',geometry('graphics-operator','preview-dominant','horizontal-split',40,60,'protect-preview')],
 ...
 ['streaming-operator','Streaming Operator','⇧','Protect program and destination health',geometry('streaming-operator','program-dominant','horizontal-split',65,35,'protect-program')],
 ...
 ['scenes','Scenes','▤','Prepare the next scene before taking it live',geometry('scenes','preview-dominant','horizontal-split',45,55,'protect-preview')],
