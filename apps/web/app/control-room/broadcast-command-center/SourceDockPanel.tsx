...
import { CompactGuestsBrowser } from '../browsers/CompactGuestsBrowser';
...
import { SceneBrowser } from '../browsers/SceneBrowser';
import { SourceBrowser } from '../browsers/SourceBrowser';

export function SourceDockPanel({
  activeTab,
  scenes,
  sceneTypes,
  guests,
  ...
  switch (activeTab) {
    ...
    case 'guests':
      return <CompactGuestsBrowser guests={guests} />;
    case 'diagnostics':
      return <DiagnosticsSummary metrics={diagnosticsMetrics} />;
    default:
      return null;
  }
}
