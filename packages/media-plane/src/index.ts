...
export {
  ...
  createMaskStack,
  validateMaskStack,
  createSourceGraphMaskingMetadata,
  defaultMaskParameters,
  MASKING_COMMAND_TYPES,
  MASKING_OUTPUT_KEYS,
  MASKING_WATCHDOG_INCIDENTS,
  MaskingError,
  DuplicateMaskingBackend,
  type MaskType,
  ...
  type MaskingStatus,
  type MaskPoint,
  type MaskRectangleShape,
  type MaskEllipseShape,
  type MaskCircleShape,
  type MaskPolygonShape,
  type MaskReferenceShape,
  type MaskTransform,
  type MaskParameters,
  type MaskStackEntry,
  type MaskStack,
  ...
  type MaskingBackendCapabilities,
