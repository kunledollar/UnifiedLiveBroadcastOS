...
export {
  ...
  MOTION_PROPERTY_SCHEMAS,
  MotionEffectsEngine,
  MotionEffectsProcessor,
  MotionEngineError,
  createMotionEffectsEngine,
  createMotionEffectsProcessor,
  createMotionInstance,
  createMotionTimeline,
  createMotionPreset,
  createMotionCommandHandlers,
  assertMotionInvariants,
  type MotionCommandType,
  type MotionTargetType,
  type MotionValueType,
  type MotionInterpolationMode,
  type MotionEasingFunction,
  ...
  type MotionWatchdogIncident,
  type MotionTarget,
  type MotionPropertySchema,
  type MotionValue,
  type MotionKeyframe,
  type MotionSpringParameters,
  type MotionTrack,
  type MotionMarker,
  type MotionTimeline,
  type MotionInstance,
  type MotionResolvedProperty,
  type MotionEvaluationPlan,
  type MotionEvaluationResult,
  type MotionConflictSnapshot,
  type MotionPreset,
  type MotionEffectsHealthSnapshot,
  type MotionEffectsTelemetrySnapshot,
  type MotionEffectsEngineSnapshot,
  type MotionValidationReport,
  type MotionTimelineSnapshot,
  type MotionTrackSnapshot,
  type MotionKeyframeSnapshot,
  type MotionMarkerSnapshot,
  type MotionPresetSnapshot,
  type MotionInstanceSnapshot,
  type MotionEvaluationPlanSnapshot,
  type MotionEvaluationResultSnapshot,
  type MotionResolvedPropertySnapshot,
