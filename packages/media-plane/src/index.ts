...
export {
  ...
  REPLAY_SOURCE_TYPES,
  REPLAY_MEDIA_FORMS,
  REPLAY_CAPTURE_POLICIES,
  REPLAY_BUFFER_TYPES,
  REPLAY_BUFFER_STATES,
  REPLAY_INDEXING_POLICIES,
  REPLAY_MARKER_TYPES,
  REPLAY_KEYFRAME_ALIGNMENT_POLICIES,
  REPLAY_AUDIO_BOUNDARY_POLICIES,
  REPLAY_DISCONTINUITY_POLICIES,
  REPLAY_CUE_MODES,
  REPLAY_PLAYBACK_DIRECTIONS,
  REPLAY_AUDIO_POLICIES,
  REPLAY_OUTPUT_ROLES,
  REPLAY_EVICTION_POLICIES,
  REPLAY_PRESSURE_STATES,
  REPLAY_PRESSURE_POLICIES,
  REPLAY_OWNERS,
  REPLAY_SESSION_STATES,
  REPLAY_CONFLICT_POLICIES,
  REPLAY_RECALL_STATUSES,
  REPLAY_COMMAND_TYPES,
  REPLAY_EVENTS,
  REPLAY_WATCHDOG_INCIDENTS,
  REPLAY_OUTPUT_KEYS,
  ReplayFoundationError,
  SyntheticReplayFoundationBackend,
  ReplayFoundationEngine,
  createReplayFoundationEngine,
  createSyntheticReplayFoundationBackend,
  ReplayFoundationProcessor,
  createReplayFoundationProcessor,
  createReplayCommandHandlers,
  ...
  type ReplayIndexingPolicy,
  type ReplayMarkerType,
  type ReplayKeyframeAlignmentPolicy,
  type ReplayAudioBoundaryPolicy,
  type ReplayDiscontinuityPolicy,
  type ReplayCueMode,
  type ReplayPlaybackDirection,
  type ReplayAudioPolicy,
  type ReplayOutputRole,
  type ReplayEvictionPolicy,
  type ReplayPressureState,
  type ReplayPressurePolicy,
  type ReplayUnitOwner,
  type ReplaySessionState,
  type ReplayConflictPolicy,
  type ReplayRecallStatus,
  type ReplayCommandType,
  type ReplayEventType,
  type ReplayWatchdogIncidentType,
  type ReplayErrorCode,
  type ReplaySourceDefinition,
  type ReplaySourceDefinitionSnapshot,
  type ReplayBufferDefinition,
  type ReplayBufferDefinitionSnapshot,
  type ReplayBufferStateSnapshot,
  type ReplayMediaUnit,
  type ReplayMediaUnitSnapshot,
  type ReplaySynchronizedMediaReference,
  type ReplaySynchronizedMediaReferenceSnapshot,
  type ReplayTimelineIndex,
  type ReplayTimelineIndexSnapshot,
  type ReplayMarker,
  type ReplayMarkerSnapshot,
  type ReplayRangeDefinition,
  type ReplayRangeDefinitionSnapshot,
  type ReplayItemDefinition,
  type ReplayItemDefinitionSnapshot,
  type ReplayBankDefinition,
  type ReplayBankDefinitionSnapshot,
  type ReplayPlaylistDefinition,
  type ReplayPlaylistDefinitionSnapshot,
  type ReplayCaptureRequest,
  type ReplayCaptureRequestSnapshot,
  type ReplayCapturePlan,
  type ReplayCapturePlanSnapshot,
  type ReplayRecallRequest,
  type ReplayRecallRequestSnapshot,
  type ReplayRecallPlan,
  type ReplayRecallPlanSnapshot,
  type ReplayRecallResult,
  type ReplayRecallResultSnapshot,
  type ReplayOutputState,
  type ReplayOutputStateSnapshot,
  type ReplayUnitLease,
  type ReplayUnitLeaseSnapshot,
  type ReplayBufferPressureSnapshot,
  type ReplayEvictionSnapshot,
  type ReplaySessionDefinition,
  type ReplaySessionDefinitionSnapshot,
  type ReplaySessionStateSnapshot,
  type ReplayRequestQueueSnapshot,
  type ReplayBackendSnapshot,
  type ReplayHealthSnapshot,
  type ReplayTelemetrySnapshot,
  type ReplayEngineSnapshot,
  type ReplayValidationReport,
  type ReplayInputMediaReference,
  type ReplayBackendCapabilities,
  type ReplayFoundationBackend,
