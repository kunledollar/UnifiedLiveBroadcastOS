...
export {
  FRAME_MEMORY_COMMAND_TYPES,
  FrameMemoryError,
  SyntheticFrameMemoryManager,
  assessFrameZeroCopy,
  createFrameMemoryCommandHandlers,
  createFrameMemoryManager,
  createFramePlaneLayout,
  validateFramePlaneLayout,
} from './frame-memory.js';
export type {
  FrameAccessMode,
  FrameAllocationRequest,
  FrameGarbageCollectionResult,
  FrameImportOwnershipMode,
  FrameImportPolicy,
  FrameImportRequest,
  FrameLease,
  FrameLeaseSnapshot,
  ...
  FrameMappedPlane,
  FrameMappedView,
  FrameMappedViewSnapshot,
  FrameMemoryCommandType,
  FrameMemoryDescriptor,
  FrameMemoryDomain,
  FrameMemoryFilter,
  FrameMemoryHealthSnapshot,
  FrameMemoryManager,
  FrameMemoryPoolSnapshot,
  FrameMemorySnapshot,
  FrameMemorySystemSnapshot,
  FrameMemoryTelemetrySnapshot,
  FrameMemoryTransitionRequest,
  FrameMemoryTransitionResult,
  FrameMemoryTransitionSnapshot,
  FrameOwnerRole,
  FramePinReason,
  FramePlaneLayout,
  FramePlaneRole,
  FramePoolClassSnapshot,
  FramePoolPressureState,
  FrameReferenceCounts,
  FrameState,
  FrameStorageType,
  FrameUsageFlag,
  FrameViewRequest,
