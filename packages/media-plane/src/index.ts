...
export {
  UBOS_AUTOMATION_PLATFORM_CERTIFICATION_STATUS,
  UBOS_AUTOMATION_PLATFORM_RELEASE_NAME,
  UBOS_AUTOMATION_PLATFORM_RELEASE_READY,
  UBOS_AUTOMATION_PLATFORM_VERSION,
} from './automation-platform-release.js';
