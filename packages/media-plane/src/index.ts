...
export {
  ...
  AudioAlreadyCapturing,
  AudioAlreadyOpen,
  AudioChannelGroupNotFound,
  AudioControlOutOfRange,
  AudioControlUnsupported,
  AudioFormatUnsupported,
  AudioLoopbackUnsupported,
  AudioNotCapturing,
  AudioNotOpen,
  AudioOwnershipViolation,
  AudioPermissionDenied,
  AudioSourceError,
  DefaultAudioDeviceSource,
...
export type {
  ...
  AudioBackendBuffer,
  AudioBackendContext,
  AudioBackendHealthSnapshot,
  AudioBackendOpenRequest,
  AudioBackendOpenResult,
  AudioBufferCallback,
  AudioBufferOwnership,
  AudioBufferPayload,
  AudioCaptureBackend,
  AudioChannelGroup,
  AudioChannelLayout,
  ...
  AudioDeviceControlResult,
  AudioDeviceControlSnapshot,
  AudioDeviceDiscoveryRequest,
  AudioDeviceDiscoveryResult,
  AudioDeviceSource,
  AudioDeviceSourceProvider,
  AudioFormatNegotiationRequest,
  ...
  AudioSourceHealthSnapshot,
  AudioSourceSnapshot,
  AudioUnderflowPolicy,
} from './audio-device-source.js';
