...
export {
  ...
  TRANSITION_OUTPUT_KEYS,
  TRANSITION_WATCHDOG_INCIDENTS,
  TRANSITION_EVENTS,
  TRANSITION_ERRORS,
  TransitionExecutionError,
  TransitionExecutionEngine,
  TransitionExecutionProcessor,
  createTransitionCommandHandlers,
  ...
  type TransitionInstanceState,
  type TransitionResultStatus,
  type TransitionInterruptionPolicy,
  type TransitionCancellationPolicy,
  type TransitionSceneReference,
  type TransitionDefinition,
  type TransitionExecutionRequest,
  type TransitionProgressSnapshot,
  type TransitionExecutionPlan,
  type TransitionExecutionInstance,
  type TransitionExecutionResult,
  type TransitionDefinitionSnapshot,
  type TransitionInstanceSnapshot,
  type TransitionPlanSnapshot,
  type TransitionRequestSnapshot,
  type TransitionResultSnapshot,
  type TransitionQueueSnapshot,
  type TransitionExecutionTelemetrySnapshot,
  type TransitionExecutionHealthSnapshot,
  type TransitionExecutionEngineSnapshot,
  type TransitionValidationReport,
  type TransitionCompositorAdapter,
  type TransitionProgramAdapter,
