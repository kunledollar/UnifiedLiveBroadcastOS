...
export {
  AV_SYNC_COMMAND_TYPES,
  AV_SYNC_CORRECTION_POLICIES,
  AV_SYNC_EVENTS,
  AV_SYNC_MODES,
  AV_SYNC_OUTPUT_KEYS,
  AV_SYNC_PROCESSOR_ORDER,
  AV_SYNC_RESULT_STATUSES,
  AV_SYNC_STATUSES,
  AV_SYNC_VERSION,
  AV_SYNC_WATCHDOG_INCIDENTS,
  CLOCK_CORRELATION_STATES,
  CLOCK_DOMAINS,
  MASTER_AUDIO_BUS_ROLES,
  MASTER_TIMELINE_STATES,
  AudioVideoSyncError,
  AudioVideoSyncMasterAudioEngine,
  AudioVideoSyncMasterBusProcessor,
  SyntheticAudioVideoSynchronizationBackend,
  SyntheticMasterAudioBusBackend,
  createAudioDelayCompensationDefinition,
  createAudioVideoSyncCommandHandlers,
  createAudioVideoSyncConfigurationTransaction,
  createAudioVideoSyncMasterAudioEngine,
  createAudioVideoSyncMasterBusProcessor,
  createAudioVideoSyncSourceGraphSnapshot,
  createDefaultAudioVideoSyncTolerancePolicy,
  createMasterAudioBusDefinition,
  createMediaTimestamp,
  createRationalTimeBase,
  createSyntheticAudioVideoSynchronizationBackend,
  createSyntheticMasterAudioBusBackend,
  createVideoDelayCompensationDefinition,
  normalizeTimestampToNs,
  resolveMasterMute,
  validateAudioVideoSyncTolerancePolicy,
  type MediaTimestamp,
