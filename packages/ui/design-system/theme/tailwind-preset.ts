  ...
  theme: {
    extend: {
      colors: {
        ubos: {
          ...
          selection: {
            ...
            hover: 'var(--ubos-selection-hover)',
            active: 'var(--ubos-selection-active)',
            elevated: 'var(--ubos-selection-elevated)',
            dimmed: 'var(--ubos-selection-dimmed)',
            muted: 'var(--ubos-selection-muted)',
            border: 'var(--ubos-selection-border)',
            text: 'var(--ubos-selection-text)',
          },
          automation: {
            DEFAULT: 'var(--ubos-automation)',
            hover: 'var(--ubos-automation-hover)',
            active: 'var(--ubos-automation-active)',
            elevated: 'var(--ubos-automation-elevated)',
            dimmed: 'var(--ubos-automation-dimmed)',
            muted: 'var(--ubos-automation-muted)',
            border: 'var(--ubos-automation-border)',
            text: 'var(--ubos-automation-text)',
          },
          graphics: {
            DEFAULT: 'var(--ubos-graphics)',
            hover: 'var(--ubos-graphics-hover)',
            active: 'var(--ubos-graphics-active)',
            elevated: 'var(--ubos-graphics-elevated)',
            dimmed: 'var(--ubos-graphics-dimmed)',
            muted: 'var(--ubos-graphics-muted)',
            border: 'var(--ubos-graphics-border)',
            text: 'var(--ubos-graphics-text)',
          },
          replay: {
            DEFAULT: 'var(--ubos-replay)',
            hover: 'var(--ubos-replay-hover)',
            active: 'var(--ubos-replay-active)',
            elevated: 'var(--ubos-replay-elevated)',
            dimmed: 'var(--ubos-replay-dimmed)',
            muted: 'var(--ubos-replay-muted)',
            border: 'var(--ubos-replay-border)',
            text: 'var(--ubos-replay-text)',
          },
          warning: {
            DEFAULT: 'var(--ubos-warning)',
            hover: 'var(--ubos-warning-hover)',
            active: 'var(--ubos-warning-active)',
            elevated: 'var(--ubos-warning-elevated)',
            dimmed: 'var(--ubos-warning-dimmed)',
      ...
      boxShadow: {
        ...
        // UBDS elevation levels 0-4 (Step 91)
        'ubos-elevation-1': 'var(--ubos-elevation-1)',
        'ubos-elevation-2': 'var(--ubos-elevation-2)',
        'ubos-elevation-3': 'var(--ubos-elevation-3)',
        'ubos-elevation-4': 'var(--ubos-elevation-4)',
      },
      transitionDuration: {
